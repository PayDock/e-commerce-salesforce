...
function getCustomerPaymentInstruments(userPaymentInstruments) {
    ...
    paymentInstruments = userPaymentInstruments.map(function (paymentInstrument) {
        var result = {
            ...
            custom: {
              powerboardVaultToken: paymentInstrument instanceof dw.customer.CustomerPaymentInstrument ?
                (paymentInstrument.custom.powerboardVaultToken || '') :
                (paymentInstrument.raw.custom.powerboardVaultToken || '')
            }
        };
