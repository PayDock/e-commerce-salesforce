                    ...
                    if (isMultiShip && form.length === 0) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                // init PowerBoard Widget at the payment stage of Checkout
                                billingHelpers.methods.powerboardWidgetInit();
                            },
                            error: function (err) {
                                // enable the next:Payment button here
                                $('body').trigger('checkout:enableButton', '.next-step-button button');
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.error) {
                                ...
                                // reload PowerBoard Widget on error
                                billingHelpers.methods.powerboardWidgetReload();
                                ...
                                // init PowerBoard Wallet Buttons Widget at the Order Summary page
                                summaryHelpers.methods.powerboardWalletButtonsWidgetInit();

                                // init PowerBoard Checkout Button Afterpay Widget at the Order Summary page
                                summaryHelpers.methods.powerboardCheckoutButtonAfterpayWidgetInit();

                                // init PowerBoard Checkout Button ZipMoney Widget at the Order Summary page
                                summaryHelpers.methods.powerboardCheckoutButtonZipMoneyWidgetInit();

                                // init PowerBoard 3DS Widget at the Order Summary page
                                summaryHelpers.methods.powerboard3DSCanvasWidgetInit();
