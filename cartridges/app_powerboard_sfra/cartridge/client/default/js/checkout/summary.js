...
function powerboardWalletButtonsWidgetInit() {
    ...
    for (var i = 0; i < powerboardWalletButtonsWidgets.length; i++) {
        ...
        powerboardWalletButtonsEnv = ['sandbox', 'staging', 'production'].indexOf(powerboardWalletButtonsEnv) !== -1 ?
        ...
        if (powerboardWalletButtonsToken) {
            ...
            button.setEnv(
                powerboardWalletButtonsEnv === 'sandbox' ?
                'preproduction_cba' :
                (
                    powerboardWalletButtonsEnv === 'staging' ?
                        'staging_cba' :
                        'production_cba'
                )
            );
...
function powerboardCheckoutButtonAfterpayWidgetInit() {
    ...
    powerboardCheckoutButtonEnv = ['sandbox', 'staging', 'production'].indexOf(powerboardCheckoutButtonEnv) !== -1 ?
    ...
    if (powerboardPublicKey && powerboardGatewayId && powerboardTokenNameElement && powerboardMeta) {
        ...
        button.setEnv(
            powerboardCheckoutButtonEnv === 'sandbox' ?
            'preproduction_cba' :
            (
                powerboardCheckoutButtonEnv === 'staging' ?
                    'staging_cba' :
                    'production_cba'
            )
        );
