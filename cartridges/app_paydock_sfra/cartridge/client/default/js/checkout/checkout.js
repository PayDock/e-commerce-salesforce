                    ...
                    if (isMultiShip && form.length === 0) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                // init Paydock Widget at the payment stage of Checkout
                                billingHelpers.methods.paydockWidgetInit();
                            },
                            error: function (err) {
                                // enable the next:Payment button here
                                $('body').trigger('checkout:enableButton', '.next-step-button button');
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.error) {
                                ...
                                // init Paydock Wallet Buttons Widget at the Order Summary page
                                summaryHelpers.methods.paydockWalletButtonsWidgetInit();

                                // init Paydock Checkout Button Afterpay Widget at the Order Summary page
                                summaryHelpers.methods.paydockCheckoutButtonAfterpayWidgetInit();

                                // init Paydock Checkout Button ZipMoney Widget at the Order Summary page
                                summaryHelpers.methods.paydockCheckoutButtonZipMoneyWidgetInit();

                                // init Paydock 3DS Widget at the Order Summary page
                                summaryHelpers.methods.paydock3DSCanvasWidgetInit();
