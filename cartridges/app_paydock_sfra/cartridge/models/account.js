...
function getCustomerPaymentInstruments(userPaymentInstruments) {
    ...
    paymentInstruments = userPaymentInstruments.map(function (paymentInstrument) {
        var result = {
            ...
            custom: {
              paydockVaultToken: paymentInstrument instanceof dw.customer.CustomerPaymentInstrument ?
                (paymentInstrument.custom.paydockVaultToken || '') :
                (paymentInstrument.raw.custom.paydockVaultToken || '')
            }
        };
