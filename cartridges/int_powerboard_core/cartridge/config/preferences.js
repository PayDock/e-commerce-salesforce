...
base.powerboard = {
    ...
    powerboardEnvironment: currentSite.getCustomPreferenceValue('powerboardEnvironment').value,
    ...
    powerboardWalletButtonsApplePayMerchantIdDomainAssociation: currentSite.getCustomPreferenceValue('powerboardWalletButtonsApplePayMerchantIdDomainAssociation'),
    ...
    powerboardCheckoutButtonAfterpayChargeCapture: false,
